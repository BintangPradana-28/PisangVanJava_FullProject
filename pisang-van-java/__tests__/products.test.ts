...
describe('MENU_VARIANTS', () => {
  it('has exactly 12 variants', () => {
    expect(MENU_VARIANTS).toHaveLength(12)
  })
...
describe('TOPPINGS', () => {
  it('has exactly 5 toppings', () => {
    expect(TOPPINGS).toHaveLength(5)
  })
  it('all toppings cost 2000', () => {
    TOPPINGS.forEach((t) => expect(t.price).toBe(2000))
  })
})
