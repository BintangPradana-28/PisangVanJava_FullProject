...
> = {
  PROCESSING: {
    ...
    emoji: '🍳',
    description:
      'Kabar baik! Dapur kami telah menerima pesanan Anda dan saat ini sedang mempersiapkannya dengan bahan-bahan premium terbaik. Kami akan memberitahu Anda kembali jika pesanan sudah siap.'
  },
  READY: {
    ...
    emoji: '🎉',
    description:
      'Hore! Pesanan Anda sudah siap disajikan. Jika Anda memilih metode Pickup, silakan datang ke outlet kami. Jika Anda memilih metode Delivery, kurir kami akan segera mengantarkannya ke alamat Anda.'
  },
  COMPLETED: {
    ...
    emoji: '🍌',
    description:
      'Terima kasih telah menikmati Pisang Goreng Van Java! Kami harap Anda menyukai hidangan kami. Bagikan ulasan Anda di website kami untuk membantu kami terus meningkatkan kualitas pelayanan.',
  ...
  CANCELED: {
    ...
    emoji: '❌',
    description:
      'Pesanan Anda telah dibatalkan. Jika Anda merasa ini adalah kesalahan atau memerlukan informasi lebih lanjut mengenai pengembalian dana, silakan hubungi layanan pelanggan kami via WhatsApp.'
  }
}

export const OrderStatusEmail = ({ customerName, orderId, status }: OrderStatusEmailProps) => {
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={buttonContainer}>
            <Link style={button} href={trackLink}>
