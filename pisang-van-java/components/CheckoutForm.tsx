...
import { type CheckoutFormValues, checkoutSchema } from '@/src/lib/validations/checkout'
    ...
    <div className="max-w-md mx-auto p-6 bg-white dark:bg-[#1a0f0a] rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          ...
          />
          {errors.nama && (
            <p className="mt-1 text-sm text-red-500 font-medium">{errors.nama.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.whatsapp && (
            <p className="mt-1 text-sm text-red-500 font-medium">{errors.whatsapp.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.catatan && (
            <p className="mt-1 text-sm text-red-500 font-medium">{errors.catatan.message}</p>
          )}
        </div>
