...
export default function MapPicker({ position, setPosition, setAddressName }: MapPickerProps) {
  ...
  if (!mounted) {
    return <div className="w-full h-[300px] bg-zinc-100 dark:bg-zinc-800 animate-pulse rounded-xl flex items-center justify-center text-zinc-400">Loading Map...</div>
  }

  const defaultCenter: [number, number] = [-6.914744, 107.609810] // Bandung center
