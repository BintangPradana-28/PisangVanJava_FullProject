import { MessageCircle, FileText, AlertTriangle, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div>
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mt-1">Kami siap membantu setiap kendala pesanan Anda. Temukan jawaban atau hubungi kami langsung.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-6 md:p-8 bg-white dark:bg-zinc-900 border border-zinc-200/50 dark:border-zinc-800/80 rounded-3xl shadow-sm hover:border-green-500/30 hover:shadow-md transition-all group flex flex-col h-full">
          ...
          <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-3">Chat Customer Service</h2>
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-8 flex-1 leading-relaxed">
            Hubungi tim kami langsung melalui WhatsApp untuk respon instan. Jam operasional CS kami dari 08:00 hingga 22:00 WIB.
          </p>
          <a 
        ...
        <div className="p-6 md:p-8 bg-white dark:bg-zinc-900 border border-zinc-200/50 dark:border-zinc-800/80 rounded-3xl shadow-sm hover:border-red-500/30 hover:shadow-md transition-all group flex flex-col h-full">
          ...
          <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-3">Lapor Masalah Pesanan</h2>
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-8 flex-1 leading-relaxed">
            Pesanan tidak sesuai, kurang lengkap, atau terlambat? Laporkan langsung ke manajemen untuk evaluasi dan kompensasi.
          </p>
          <Link 
      ...
      <div className="pt-8">
        ...
        <div className="space-y-4">
          {[
            { q: "Bagaimana cara membatalkan pesanan?", a: "Pesanan yang sudah dibayar dan masuk ke tahap proses tidak dapat dibatalkan melalui sistem. Harap hubungi Customer Service jika terjadi kesalahan mendesak." },
            { q: "Berapa lama batas waktu pembayaran?", a: "Sistem memberikan waktu 15 menit untuk menyelesaikan pembayaran via Midtrans. Lewat dari itu, invoice akan hangus otomatis." },
            { q: "Bagaimana cara kerja Koin Pisang?", a: "1 Koin Pisang setara dengan Rp 1. Anda mendapatkan poin dari event atau pesanan. Koin hanya dapat memotong total tagihan belanja dan tidak dapat ditarik tunai." },
            { q: "Apakah ada diskon untuk pembelian partai besar (B2B)?", a: "Ya, kami melayani pesanan katering dan partai besar. Silakan hubungi Customer Service untuk negosiasi harga khusus." }
          ].map((faq, i) => (
            <div key={i} className="p-5 md:p-6 bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200/50 dark:border-zinc-800/50 shadow-sm">
