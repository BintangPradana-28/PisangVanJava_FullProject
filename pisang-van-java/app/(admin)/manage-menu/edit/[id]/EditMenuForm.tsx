...
import type { MenuVariantFormData } from '@/data/types'
            ...
            {[
              ...
              <div key={key}>
                ...
                <input
                  ...
                  onChange={(e) => set(key as keyof MenuVariantFormData, e.target.value)}
                  min={5000}
                  step={1000}
                  className="form-input"
                  required
          ...
          >
            {uploading ? (
              <>
                ...
                <span className="text-sm text-brown-400">Mengupload...</span>
              </>
            ) : (
              <>
                <div className="text-3xl">📷</div>
                <span className="text-sm text-brown-400">Klik atau seret gambar ke sini</span>
                <span className="text-xs text-brown-300">JPG, PNG, WEBP — maks 5 MB</span>
              </>
            )}
          </div>
          <input
