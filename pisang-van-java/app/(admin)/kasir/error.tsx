...
export default function ErrorKasir({
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center bg-gray-50 p-6 text-center">
      <div className="bg-white p-8 rounded-[4px] shadow-sm max-w-md border border-red-100">
        ...
        <button
          onClick={() => reset()}
          className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-6 rounded-[4px] active:scale-95 transition-all shadow-sm shadow-orange-500/30"
        >
          Coba Muat Ulang
        </button>
      </div>
