    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-900 text-neutral-100 p-4">
      <div className="max-w-md w-full bg-neutral-800 rounded-2xl p-8 shadow-xl text-center border border-red-900/50">
        ...
        <p className="text-neutral-400 mb-8 leading-relaxed">
          Akun Anda telah ditangguhkan karena melanggar ketentuan layanan kami atau terdeteksi
          adanya aktivitas yang mencurigakan. Jika Anda merasa ini adalah sebuah kesalahan, silakan
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <Link href="/kontak">Hubungi Support</Link>
          </Button>
          <Button
            asChild
            variant="ghost"
            className="w-full text-neutral-400 hover:text-white hover:bg-neutral-700"
          >
